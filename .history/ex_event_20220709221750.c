 ...
 * @LastEditTime: 2022-07-09 22:17:49
...
#include "pub.h"
// TODO
void read_cb(struct bufferevent *pbuffer)
{
    int recvlen=0;
    char buff[1024]={0};
...
// TODO
void write_cb(struct bufferevent *p_buff){
    if(NULL==p_buff)
    {
        return;
    }
...
// TODO
void listen_cb(struct evconnlistener *p_listener, evutil_socket_t fd, struct sockaddr *p_sock_addr, s64 socklen, void *data)
{
    s64 ret = 0;
    s64 session_index = -1;
...
int event_main()
{
    ...
    // TODO
    g_event_listener = evconlistener_new_bind(g_base, listen_cb, NULL,
