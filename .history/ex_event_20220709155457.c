 ...
 * @LastEditTime: 2022-07-09 15:52:55
...
#include "pub.h"
// TODO
static read_cb(struct buffervent *pbuffer)
{
    int recvlen=0;
    char buff[1024]={0};
...
// TODO
static void write_cb(struct bufferevent *p_buff){
    if(NULL==p_buff)
    {
        return;
    }
...
// TODO
static void listen_cb(struct evconnlistener *p_listener, evutil_socket_t fd, struct sockaddr *p_sock_addr, s64 socklen, void *data)
{
    s64 ret = 0;
    s64 session_index = -1;
